...
@section('content')
    ...
    <body>
        ...
        <div class="backAndNext">
            <a class="btn btn-success" href="{{ route('template_six')}}" id="btnBack"><i class="fas fa-hand-point-left"></i></a>
            <a class="btn btn-success " href="{{ route('templates')}}" id="btnAllTemplates">Templates</a>
            <a class="btn btn-success" href="{{ route('template_eigth')}}" id="btnBack"><i class="fas fa-hand-point-right"></i></a>
        </div>
